...
namespace Zatomic.AI.Providers.Samples
{
	...
	public class HyperbolicSamples : BaseSample
	{
		private readonly string _apiKey;
		private readonly string _model;

		public HyperbolicSamples()
		{
			_apiKey = Configuration["Hyperbolic:ApiKey"];
			_model = Configuration["Hyperbolic:Model"];
		}

		[Test]
		public async Task Chat()
		{
			var client = new HyperbolicChatClient(_apiKey) { Timeout = Timeout };
			var request = new HyperbolicChatRequest(_model);
