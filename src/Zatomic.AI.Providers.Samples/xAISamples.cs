...
namespace Zatomic.AI.Providers.Samples
{
	...
	public class xAISamples : BaseSample
	{
		...
		public xAISamples()
		{
			...
			_model = Configuration["xAI:Model"];
		}

		[Test]
		public async Task Chat()
		{
			var client = new xAIChatClient(_apiKey) { Timeout = Timeout };
			var request = new xAIChatRequest(_model);
