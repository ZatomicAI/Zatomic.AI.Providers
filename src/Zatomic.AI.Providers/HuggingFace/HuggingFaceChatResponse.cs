...
namespace Zatomic.AI.Providers.HuggingFace
{
	public class HuggingFaceChatResponse
	{
		...
		public List<HuggingFaceChatChoice> Choices { get; set; }
		...
		[JsonProperty("usage")]
		public HuggingFaceChatUsage Usage { get; set; }

		public HuggingFaceChatResponse()
		{
			Choices = new List<HuggingFaceChatChoice>();
		}
	}
}
