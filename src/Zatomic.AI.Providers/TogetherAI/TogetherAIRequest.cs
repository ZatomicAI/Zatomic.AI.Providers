...
{
	public class TogetherAIRequest : BaseRequest
	{
		...
		public List<TogetherAIMessage> Messages { get; set; }
		...
		public TogetherAIRequest()
		{
			Messages = new List<TogetherAIMessage>();
		}
		...
		{
			Messages.Add(new TogetherAIMessage { Role = role, Content = content });
		}
	}
}
