...
namespace Zatomic.AI.Providers.FireworksAI
{
	public class FireworksAIChatClient
	{
		...
		public FireworksAIChatClient(string apiKey) : this()
		{
			ApiKey = apiKey;
		}

		public async Task<FireworksAIChatResponse> ChatAsync(FireworksAIChatRequest request)
		{
			FireworksAIChatResponse response = null;
			...
			using (var httpClient = new HttpClient())
			{
				...
				try
				{
					...
					response = responseJson.Deserialize<FireworksAIChatResponse>();
