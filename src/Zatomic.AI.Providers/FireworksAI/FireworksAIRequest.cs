...
{
	public class FireworksAIRequest : BaseRequest
	{
		...
		public List<FireworksAIMessage> Messages { get; set; }
		...
		public FireworksAIResponseFormat ResponseFormat { get; set; }
		...
		public FireworksAIRequest()
		{
			Messages = new List<FireworksAIMessage>();
		}
		...
		{
			Messages.Add(new FireworksAIMessage { Role = role, Content = content });
		}
	}
}
